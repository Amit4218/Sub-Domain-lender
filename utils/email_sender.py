...
def send_reset_password_email(user_email: str, user_name: str, token: str):
    html_structure = f"""
    <html>
    <head>
        <style>
    ...
    <body>
        <div class="container">
            <div class="content">
                <p>Hi {user_name} here is your Password reset link</p>
                <div class="verification-box">
                    <strong>Reset you'r password by clicking the link below:</strong><br>
